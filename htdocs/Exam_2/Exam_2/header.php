                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <span class="text-black text-center"><strong>User ID : <?=$_SESSION['login_id']?></strong></span>
                                        <span class="text-black"><strong><?=$_SESSION['login_name']?></strong></span>
                                        <p class="fs-12 mb-0"><?=$_SESSION['login_email']?></p>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item dropdown header-profile">
                                    <div class="header-info">
                                        <div class="alert alert-danger">
                                            <span class="ml-2"><a href="error.php">Logout</a> </span>
                                        </div>
                                    </div>
                            </li>
                        </ul>
